...
RSpec.describe Tweet, type: :model do 
  ...
  it 'exists and has readable attributes' do 
    tweet = Tweet.create!(created_at: "2022-10-12T18:11:18.000Z", text: "NASA Awards Contracts to Assess Near-Space Communications Capabilities https://t.co/NLVzuGsExg #NASA #space", edit_history_tweet_ids: ["1580259830799159296"], lang: "en", subject: "nasa")
    ...
    expect(tweet.subject).to eq("nasa")
  end 
end 